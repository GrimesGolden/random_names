...
void name(int total) {
	...
	vector<string> first = {"Danny", "Virgil", "Johnny", "Lil", "ASAP", "Ratchet", "Piper", "Master", "Vector", "Jackson", "Shootie", "Big", "Lieutenant", "Commander", "Froggie", "Pimp", "Mr.", "Merlot", "Fattie", "Shawn", "Slaine", "HomeBoy", "Prozac", "Goats", "Dirt", "Young", "Freddy", "Ridgeback", "Dollarbill", "Tyler", "Sadboy", "Conner", "Maxo", "Dante", "Tyrone", "Taylor", "Doug", "Slapface", "Susboy", "Joe"};
